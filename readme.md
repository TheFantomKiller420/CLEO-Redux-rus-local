...
- [Пользовательские сценарии](#пользовательские-сценарии)
	...
	- [Интеграция с Atom](#интеграция-с-atom)
...
Вся информация [тут](https://github.com/TheFantomKiller420/CLEO-Redux-integration-with-Atom)

Примечание: Советую пользоваться оригинальной [интеграцией с Visual Studio Code](#интеграция-с-visual-studio-code) ибо интеграция с Atom сделана любителем (мной), к тому же она находится на стадии разработки.
